        ...
        <div className="rounded-2xl border border-border/70 bg-gradient-to-br from-[#e8f3ef] via-white to-[#e6eef8] p-6 sm:p-8">
          <div className="flex items-center gap-2">
            ...
            >
              <button
                type="button"
                className="inline-flex size-6 items-center justify-center rounded-full text-[#4d6a60] transition-colors hover:bg-[#16352c]/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              ...
              {isSpendingTooltipOpen ? (
                <div
                  ...
                  role="tooltip"
                  className="absolute left-0 top-full z-50 mt-2 w-[min(100vw-2rem,20rem)] rounded-xl border border-border/70 bg-white p-3 text-sm text-muted-foreground shadow-lg"
                >
